...
console.log({
  PREPROC_CACHED_LOCALLY: env.PREPROC_CACHED_LOCALLY,
  NODE_ENV: env.NODE_ENV
});

export const preprocEndpoint =
  env.PREPROC_CACHED_LOCALLY === 'true'
    ? 'http://localhost:8000'
...
export const holonymAuthMessage =
  'Signature requested for holonym.id. Do not sign this on any other website!';

export const holonymKeyGenMessage = 'Holonym keygen';

export const defaultActionId = '123456789';

export const defaultChainToProveOn =
  env.NODE_ENV === 'development' ? 'optimism-goerli' : 'optimism';

export const maxDailyVouchedJobCount = 5000;

export const zokratesFieldPrime =
