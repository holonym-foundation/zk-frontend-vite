...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route
        path={'/issuance/idgov/:store'}
        element={<GovernmentIDIssuance />}
      />
      <Route path={'/issuance/phone'} element={<PhoneNumberIssuance />} />
      <Route
        path={'/issuance/phone/:store'}
        element={<PhoneNumberIssuance />}
      />
      <Route path={'/issuance/med'} element={<MedicalCredentialsIssuance />} />
      <Route
        path={'/issuance/med/:store'}
        element={<MedicalCredentialsIssuance />}
      />
      <Route
        path={'/issuance/external/:store'}
        element={<ExternalIssuance />}
      />
      ...
      <Route
        path={'/prove/:proofType/:actionId/:callback'}
        element={<OnChainProofs />}
      />
      <Route path={'/prove/:proofType/:actionId'} element={<OnChainProofs />} />
      <Route path={'/prove/:proofType'} element={<OnChainProofs />} />
      <Route
        path={'/prove/off-chain/:proofType/:actionId/:callback'}
        element={<OffChainProofs />}
      />
      <Route
        path={'/prove/off-chain/:proofType/:actionId'}
        element={<OffChainProofs />}
      />
      <Route
        path={'/prove/off-chain/:proofType'}
        element={<OffChainProofs />}
      />
