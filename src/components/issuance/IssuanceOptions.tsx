...
const opts = [
	{
		...
		image: phoneImg,
		description:
			"This adds a phone number to your Holo if it's a real number / not a burner. It lets you to prove you're not a bot, for Sybil resistance.",
		disabled: false,
	},
	{
		...
		image: idImg,
		description:
			"This verifies your government ID (driver's license or ID card). You can prove you're not a bot for Sybil resistance. You can prove facts about your age, jurisdiction, and KYC/AML checks.",
		disabled: false,
	},
	{
		...
		description:
			"This adds medical credentials to your Holo. It lets you prove that you are a doctor and what specialty you are in.",
		disabled: false,
	},
	{
