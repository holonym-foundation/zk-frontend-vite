      ...
      {!account?.address ? (
        ...
        <div className="x-wrapper small-center" style={{ width: '100%' }}>
          ...
          <p>
            ...
            for these attributes about yourself. E.g., if you are a us resident,
            you can get a US Resident SBT
          </p>
          ...
          <button
            ...
            className="x-button"
          >
            Unique Personhood (government ID)
          </button>
          <div className="spacer-large" />
          <button
            onClick={() => {
            ...
            className="x-button"
          >
            Unique Personhood (phone number)
          </button>
          <div className="spacer-large" />
          <button
            onClick={() => {
              navigate('/prove/medical-specialty');
            }}
            className="x-button"
          >
            Medical Specialty
