      ...
      <div className="x-wrapper footer">
        ...
        <div className="footer-right-div">
          <div className="social-wrapper">
            <a
              href="https://twitter.com/0xHolonym"
            ...
            <a
              href="https://github.com/holonym-foundation"
              className="social-link-block w-inline-block"
            >
              <img
                src={HoloGithubLogo}
            ...
            <a
              href="https://discord.gg/zPzsEAXrQt"
              className="social-link-block w-inline-block"
            >
              <img
                src={HoloDiscordLogo}
